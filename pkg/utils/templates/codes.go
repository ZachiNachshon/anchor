...
// This file was taken from https://github.com/manifoldco/promptui/blob/master/codes.go
// This repository is using promptui for triggering the selection prompts.
// When using Go templates from outside promptui, we would like to have the same color behavior
